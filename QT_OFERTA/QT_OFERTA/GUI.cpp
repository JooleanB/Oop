...
void ProductGUI::create_interface()
{
    ...
    button_layout->addWidget(butonAdaugaCos);
    button_layout->addWidget(butonGenerareCos);
    button_layout->addWidget(butonStergeCos);
...
void ProductGUI::interface_connect()
{
    ...
    QObject::connect(butonAdaugaCos, &QPushButton::clicked, [&]() { GUIadd_cos(); });
