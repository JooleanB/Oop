...
static constexpr auto qt_meta_stringdata_CLASSProduseENDCLASS = QtMocHelpers::stringData(
    "Produse"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSProduseENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSProduseENDCLASS_t qt_meta_stringdata_CLASSProduseENDCLASS = {
    {
