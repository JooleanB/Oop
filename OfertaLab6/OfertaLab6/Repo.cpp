...
void OfertaRepo::modify(const string& denumire, const string& destinatie, const string& newDenumire, const string& newDestinatie, const string& newTip, int newPret) {
	...
	try {
		...
		it->setDenumire(newDenumire);
		it->setDestinatie(newDestinatie);
		it->setTip(newTip);
		it->setPret(newPret);
		metoda1();
	}
